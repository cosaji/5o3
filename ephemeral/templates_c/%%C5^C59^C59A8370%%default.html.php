<?php /* Smarty version 2.6.26, created on 2014-10-30 06:46:11
         compiled from iphones/internals/reissue/default.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'iphones/internals/reissue/default.html', 4, false),)), $this); ?>
...
" />
					<dl>
						<dt>メールアドレス</dt>
							<dd><input type="text" name="reissue[mail]" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['input']['reissue']['mail'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></dd>
					</dl>
