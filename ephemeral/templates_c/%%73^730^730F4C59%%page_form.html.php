<?php /* Smarty version 2.6.26, created on 2012-09-20 23:12:46
         compiled from internals/admin/page_form.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'internals/admin/page_form.html', 3, false),array('modifier', 'explode', 'internals/admin/page_form.html', 53, false),array('modifier', 'in_array', 'internals/admin/page_form.html', 55, false),array('modifier', 'date_format', 'internals/admin/page_form.html', 115, false),array('modifier', 'default', 'internals/admin/page_form.html', 184, false),)), $this); ?>
...
images/icons/media_add.png" alt="メディア登録" title="メディア登録" width="16" height="16" /></a></dt>
						<dd><textarea name="page[text]" cols="65" rows="30" id="tiny_mce"><?php echo ((is_array($_tmp=$this->_tpl_vars['input']['page']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></dd>
