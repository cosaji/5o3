<?php /* Smarty version 2.6.26, created on 2013-08-25 03:12:23
         compiled from internals/admin/iframe_media_form.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'internals/admin/iframe_media_form.html', 2, false),array('modifier', 'cat', 'internals/admin/iframe_media_form.html', 44, false),)), $this); ?>
...
&amp;<?php else: ?>?<?php endif; ?>type=iframe"><!--<?php if (((is_array($_tmp=$this->_tpl_vars['freo']['query']['path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))): ?>-->この階層の<!--<?php endif; ?>-->メディアを一欄表示する</a>。</li>
	</ul>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['directory'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
	...
	<form action="<?php echo ((is_array($_tmp=$this->_tpl_vars['freo']['core']['http_file'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/admin/media_delete?type=iframe" method="get" class="delete">
		<fieldset>
...
<?php endif; ?>&amp;type=iframe" method="post">
		<fieldset>
...
&amp;path=<?php echo ((is_array($_tmp=$this->_tpl_vars['freo']['query']['path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&amp;<?php else: ?>?<?php endif; ?>type=iframe" method="post" enctype="multipart/form-data">
		<fieldset>
