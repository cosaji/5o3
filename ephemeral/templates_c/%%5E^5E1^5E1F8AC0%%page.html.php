<?php /* Smarty version 2.6.26, created on 2012-09-20 23:12:48
...
<!--<?php endif; ?>--></td>
							<td>
								<!--<?php if (((is_array($_tmp=$this->_tpl_vars['page']['approved'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) == 'yes' && ( ((is_array($_tmp=$this->_tpl_vars['page']['status'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) == 'publish' || ( ((is_array($_tmp=$this->_tpl_vars['page']['status'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) == 'future' && ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['page']['datetime'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y%m%d%H%M%S') : smarty_modifier_date_format($_tmp, '%Y%m%d%H%M%S')) <= ((is_array($_tmp=((is_array($_tmp=time())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y%m%d%H%M%S') : smarty_modifier_date_format($_tmp, '%Y%m%d%H%M%S')) ) ) && ( ! ((is_array($_tmp=$this->_tpl_vars['page']['close'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) || ((is_array($_tmp=$this->_tpl_vars['page']['close'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) >= ((is_array($_tmp=((is_array($_tmp=time())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y%m%d%H%M%S') : smarty_modifier_date_format($_tmp, '%Y%m%d%H%M%S')) )): ?>-->
