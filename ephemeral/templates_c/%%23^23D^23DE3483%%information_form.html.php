<?php /* Smarty version 2.6.26, created on 2012-09-20 23:01:14
         compiled from internals/admin/information_form.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'internals/admin/information_form.html', 4, false),)), $this); ?>
...
images/icons/media_add.png" alt="メディア登録" title="メディア登録" width="16" height="16" /></a></dt>
						<dd><textarea name="information[text]" cols="50" rows="5" id="tiny_mce"><?php echo ((is_array($_tmp=$this->_tpl_vars['input']['information']['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></dd>
				</dl>
				<p>
